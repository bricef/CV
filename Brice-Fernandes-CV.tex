...
\begin{myitemize}
        ...
        \item Established a working-group operating model with charters, tiers and explicit decision rights --- eight autonomous groups covering security, architecture, AI, accessibility and people development
        \item Owned the US data residency strategy for a public-sector opportunity of $\sim$1M students, authoring the costed brief that framed the executive decision
