...
\usepackage[paper=a4paper,
            ...
            marginparwidth=25.4mm,    % Length of section titles
...
% Never hyphenate these: camel-case names break badly (e.g. "Gi-tOps")
\hyphenation{GitOps}
...
\newcommand{\makeheading}[1]%
        {\hspace*{-\marginparsep minus \marginparwidth}%
         \begin{minipage}[t]{\textwidth+\marginparwidth+\marginparsep}%
                {\large \bfseries #1} \hfill \today\\[-0.15\baselineskip]%
...
\section{Summary}
A versatile senior engineering leader who builds capability: in systems, in teams, and in the people who lead them. Experienced across the full software life cycle in complex and demanding environments, from embedded engineering to cloud-native architecture to running an engineering function, with unusual depth in governance, security and data protection. Key Achievements include being a founding coach on the University of Cambridge Judge Business School Startup Accelerator programmes and foundational contributions to the GitOps methodology.
...
%
\newlength{\rcollength}\setlength{\rcollength}{12cm}%
%
\begin{tabular}[t]{@{}p{0.35cm}p{4cm}p{2.5cm}p{5cm}}
\raggedright\faGlobe 
& \linkto{http://fractallambda.com}{fractallambda.com} 
& \hfill\faLinkedin
& \linkto{https://www.linkedin.com/in/brice-fernandes/}{linkedin.com/in/brice-fernandes/}
\\
\raggedright\faEnvelope 
& brice@fractallambda.com 
& \hfill\faStackOverflow 
& \linkto{https://stackoverflow.com/users/140264/brice?tab=profile}{stackoverflow.com/u/140264} 
\\
\raggedright\faPhone 
&+44 7548 312227
& \hfill\faGithub        
& \linkto{https://github.com/bricef}{github.com/bricef} 
\\
\raggedright\faComment 
& English, French
& \hfill\faTwitter 
&\linkto{https://twitter.com/fractallambda}{@fractallambda}
\\
\end{tabular}

\section{Skills}
%
\textsc{Leadership \& Management:} Engineering strategy and vision, Org design and resourcing, Budget ownership, R\&D leadership, Technical recruitment, Career frameworks and progression, People development and coaching, Delivery and operations, Customer Experience, Site Reliability Engineering, Incident response and business continuity, Agile principles (Scrum, Kanban and Extreme Programming practices), Lean software development, Full product development life-cycle, Technical training and skill assessment, Business modelling, Systemic innovation.

\blankline

\textsc{Governance \& Compliance:} Data protection (GDPR, ROPA, registered DPO), Security programme ownership, Cyber Essentials+, Vendor security assessment, Data residency, Risk management, Policy and audit.

\blankline

\textsc{Platforms:} Cloud Native, GitOps, AWS, GCP, Multi-cloud, Hybrid Cloud, Kubernetes, Terraform, Prometheus, Grafana, Linux administration.

\blankline

\textsc{Software Development:} Functional Programming, Python, Javascript (ES6, React, NodeJS), Go, Rust, C, C\#, F\#, Clojure, Scheme, Test Driven Development, Git, LLM-assisted development workflows, Agent-based modelling, Natural language processing.
...
%
\linkto{https://www.cambridge.org/core/journals/cambridge-archaeological-journal/article/evolution-of-complementary-cognition-humans-cooperatively-adapt-and-evolve-through-a-system-of-collective-cognitive-search/F198B30682343E92C7E9C986332D380A}{The Evolution of Complementary Cognition: Humans Cooperatively Adapt and Evolve through a System of Collective Cognitive Search.}\\
{\small Taylor, H., Fernandes, B., \& Wraight, S. (2021).  Cambridge Archaeological Journal, 1-17. \newline doi: 10.1017/S0959774321000329}

% \section{Clearance Eligibility}
% British French dual citizenship.

% Eligible for all UK security clearance levels.
...
%
\textbf{Director of Engineering at \linkto{https://www.raspberrypi.org/}{Raspberry Pi Foundation}} \hfill September 2024 - Present\\
Engineering leader for the Foundation's Digital Products division, accountable for engineering across multiple product teams building the learning platforms used by young people and educators worldwide. Line manager to the Engineering Manager cohort, reporting to the Chief Technology and Product Officer. Owned engineering vision and strategy, org design and resourcing, the engineering budget, and the security, compliance and data-protection posture of the digital estate. Member of the foundation's leadership team, representing engineering to the executive and management board.

\begin{myitemize}
        \item Designed and landed a technology-agnostic engineering career framework (Apprentice to Principal, plus a distinct management track), now in active use across 1:1s, reviews and progression decisions
        \item Established a working-group operating model with charters, tiers and explicit decision rights: eight autonomous groups covering security, architecture, AI, accessibility and people development with delegated authority and budget
        \item Owned the US and global data residency strategy for a public-sector opportunity of $\sim$1M students, authoring the costed brief that framed the executive decision
        \item Built the Foundation-wide data map ($\sim$90 systems, 20 data categories, 25 data flows) as the evidence base for ROPA and ongoing privacy compliance
        \item Led the compliance and security programme for Digital Products: Cyber Essentials+, vendor security assessments, cloud access audits, software approval, business continuity and incident response
        \item Directed engineering AI adoption through an adoption plan, a dedicated working group, and an adoption-maturity reporting tool built with external partners
        \item Grew and stabilised the team through recruitment at every level, contractor procurement, and structured investment in people development, with measurable gains in retention
\end{myitemize}

{\small \textsc{keywords:} \emph{Engineering Leadership, Org Design, Career Frameworks, People Development, Recruitment, Engineering Strategy, Architecture, Data Protection, GDPR, ROPA, Compliance, Cyber Essentials+, Security, Budget Ownership, Delivery Management, AI Adoption, Education, Non-profit}}

\blankline

\textbf{DevOps Practice Leader at \linkto{https://www.capgemini.com/}{Capgemini}} \hfill January 2022 - June 2024\\
...
\begin{myitemize}
        ...
        \item Owned technical architecture and ways of working on client engagements
...
Architected, developed and delivered hybrid cloud application platforms for some of the company's most high-profile clients, including in multiple regulated industries. Responsible for both project technical leadership and client relationships.
...
\begin{myitemize}
        ...
        \item Led the design and architecture of the internal application platform to support the autonomous vehicle project of one of the world's largest companies
...
\textbf{Instructor \& Coach, \linkto{https://www.jbs.cam.ac.uk/entrepreneurship/programmes/ignite/}{Ignite Programme} }  \hfill July 2015, July 2017\\
Instructor and coach for the University of Cambridge Judge Business School Ignite programme. The Ignite programme is a one week course aimed at transforming existing early stage enterprises through high quality lectures and challenging workshops. Responsible for leading workshops during the programme, ensuring that attendees adopted the knowledge shared into their business practice.\\
...
{\small\textsc{keywords:} \emph{C, PPC, Embedded, Python, Linux, GTK, SNMP, Agile, RFQ, Recruitment}}

\blankline

\section{Certifications}
%
\textbf{Santa Fe Institute Introduction to Agent Based Modelling} \hfill Completed August 2024\\
\textbf{Scrum Alliance Certified Agile Leadership 2} \hfill Valid to August 2026\\
\textbf{Scrum Alliance Certified Agile Leadership 1} \hfill Valid to August 2025\\
\textbf{AWS Certified Machine Learning - Specialty} \hfill Valid to October 2025\\
\textbf{AWS Certified Security - Specialty} \hfill Valid to October 2025\\
...
\textbf{MIT Media Lab: AI-Generated Media Course} \hfill Completed October 2021

\section{Selected Talks}
%
\textbf{Embedded Test Driven Development} \hfill March 2024 \\
\linkto{https://github.com/bricef/embedded-tdd-katas/blob/main/Talk/Talk.pdf?raw=true}{Slides} and \linkto{https://github.com/bricef/embedded-tdd-katas}{code} available

\blankline

\textbf{SRE Best Practices} \hfill October 2020 \\
\linkto{https://www.youtube.com/watch?v=HsBBjkNN1gs}{Video} available

\blankline 

\textbf{Bret Fisher's Docker and DevOps Podcast} \hfill November 2019 \\
\linkto{https://www.youtube.com/watch?v=5SQ411exn20}{Video} available

\blankline

\textbf{Delivering Quality at Speed with GitOps} \hfill August 2019 \\
\linkto{https://www.youtube.com/watch?v=QdCwUUtcj4I}{Video} available

\blankline

% \textbf{Using and Abusing Ruby For Computer Science Great Good} \hfill March 2017 \\
...
% More talks available on \linkto{https://fractallambda.com}{fractallambda.com}
